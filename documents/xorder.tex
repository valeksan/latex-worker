...
% : Sign :
\newcounter{cnts}
\newcommand\addQrCodeSignToArray[1] {
	\stepcounter{cnts}
	\csdef{texts\thecnts}{#1}
}
\newcommand\getQrCodeSignFromArray[1] {
	\csuse{texts#1}
}
%% -
...
\newcommand{\defCxQ}{дБ} % для изд: Соотв.
\newcommand{\defCxR}{-} % время готовности
...
\addQrCodeSignToArray{5}
\addQrCodeSignToArray{6}
\addQrCodeSignToArray{7}
\addQrCodeSignToArray{8}
...
\fancyhead[L] {
	...
	{
		\qrcode[height=1in]{\getQrCodeSignFromArray{\thepage}} \\ \ \\
	}
	{
		{\ }
	}
...
\end{tabular}
	...
	\Loop{\thecntd} {
		...
		\vspace{0.3cm}
		~\qrcode[height=2in]{\getQrCodeDataFromArray{\thestartqrs}} \\
		\vspace{0.3cm}
